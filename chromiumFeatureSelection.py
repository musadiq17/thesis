...
from chromiumFeatureExtraction import EndFeatureDict
...
port = PorterStemmer()
detoken = ''
unwantedTerms = ['&lt','&quot' ,'.org', '.html' ,'.dll' , 'abarth@chromium',';/script&gt' ,';&gt' ,'...',';&lt' ,'.exe' ,'.com' ]
...
# -----------Write CSV File---------------------------
with open('chromiumFeatures.csv', 'w', newline='') as f:
